...
async function run(D) {
  ...
  try {
    var h = s.resolve(D, "tsconfig.json");
    var m = await G(h);
    ...
    m.compilerOptions = {
      ...
      plugins: [ {
        ...
        schema: g ? s.relative(D, r) : r,
        tadaOutputLocation: s.relative(D, t)
      } ]
    };
    await a.writeFile(h, JSON.stringify(m, null, 2));
  } catch (D) {}
  e.stop("Written to tsconfig.json.");
  ((D = "") => {
